...
class _TranslationsInputScreenFi extends TranslationsInputScreenEn {
	...
	@override String get assignToGroup => 'Lisää ryhmään';
...
class _TranslationsLoadListScreenCreateGroupDialogFi extends TranslationsLoadListScreenCreateGroupDialogEn {
	_TranslationsLoadListScreenCreateGroupDialogFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
class _TranslationsLoadListScreenMoveToGroupDialogFi extends TranslationsLoadListScreenMoveToGroupDialogEn {
	_TranslationsLoadListScreenMoveToGroupDialogFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
class _TranslationsLoadListScreenDeleteGroupDialogFi extends TranslationsLoadListScreenDeleteGroupDialogEn {
	_TranslationsLoadListScreenDeleteGroupDialogFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
class _TranslationsLoadListScreenDeleteListsDialogFi extends TranslationsLoadListScreenDeleteListsDialogEn {
	_TranslationsLoadListScreenDeleteListsDialogFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
extension on TranslationsFi {
	...
	dynamic _flatMapFunction$0(String path) {
		switch (path) {
			...
			case 'inputScreen.assignToGroup': return 'Lisää ryhmään';
