...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	late final TranslationsLoadListScreenEn loadListScreen = TranslationsLoadListScreenEn.internal(_root);
...
class TranslationsDrawerEn {
	...
	late final TranslationsDrawerConfirmLogoutDialogEn confirmLogoutDialog = TranslationsDrawerConfirmLogoutDialogEn.internal(_root);
}
...
class TranslationsStartScreenEn {
	TranslationsStartScreenEn.internal(this._root);
...
class TranslationsInputScreenEn {
	TranslationsInputScreenEn.internal(this._root);
	...
	late final TranslationsInputScreenErrorsEn errors = TranslationsInputScreenErrorsEn.internal(_root);
}

// Path: loadListScreen
class TranslationsLoadListScreenEn {
	TranslationsLoadListScreenEn.internal(this._root);
	...
	late final TranslationsLoadListScreenSortOptionsEn sortOptions = TranslationsLoadListScreenSortOptionsEn.internal(_root);
}

// Path: modeSelectionScreen
class TranslationsModeSelectionScreenEn {
	TranslationsModeSelectionScreenEn.internal(this._root);
...
class TranslationsFlashcardScreenEn {
	TranslationsFlashcardScreenEn.internal(this._root);
...
class TranslationsLearnScreenEn {
	TranslationsLearnScreenEn.internal(this._root);
...
class TranslationsTestScreenEn {
	TranslationsTestScreenEn.internal(this._root);
	...
	late final TranslationsTestScreenErrorsEn errors = TranslationsTestScreenErrorsEn.internal(_root);
}

// Path: resultsScreen
class TranslationsResultsScreenEn {
	TranslationsResultsScreenEn.internal(this._root);
...
class TranslationsSettingsScreenEn {
	...
	late final TranslationsSettingsScreenExportDialogEn exportDialog = TranslationsSettingsScreenExportDialogEn.internal(_root);
	late final TranslationsSettingsScreenImportDialogEn importDialog = TranslationsSettingsScreenImportDialogEn.internal(_root);
	late final TranslationsSettingsScreenDeleteDialogEn deleteDialog = TranslationsSettingsScreenDeleteDialogEn.internal(_root);
...
class TranslationsDrawerConfirmLogoutDialogEn {
	TranslationsDrawerConfirmLogoutDialogEn.internal(this._root);
...
class TranslationsLoadListScreenSortOptionsEn {
	TranslationsLoadListScreenSortOptionsEn.internal(this._root);
...
class TranslationsLearnScreenFeedbackEn {
	TranslationsLearnScreenFeedbackEn.internal(this._root);
...
class TranslationsLearnScreenProgressEn {
	TranslationsLearnScreenProgressEn.internal(this._root);
...
class TranslationsSettingsScreenExportDialogEn {
	TranslationsSettingsScreenExportDialogEn.internal(this._root);
...
class TranslationsSettingsScreenImportDialogEn {
	TranslationsSettingsScreenImportDialogEn.internal(this._root);
...
class TranslationsSettingsScreenDeleteDialogEn {
	TranslationsSettingsScreenDeleteDialogEn.internal(this._root);
...
class TranslationsSettingsScreenSnackbarsEn {
	TranslationsSettingsScreenSnackbarsEn.internal(this._root);
