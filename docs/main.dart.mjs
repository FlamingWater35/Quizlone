...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1465: (x0,x1,x2) => x0.transaction(x1,x2),
      _1466: (x0,x1) => x0.objectStore(x1),
      _1467: (x0,x1) => x0.getAllKeys(x1),
      _1468: (x0,x1) => x0.getAll(x1),
      _1470: (x0,x1) => x0.delete(x1),
      _1471: (x0,x1,x2) => x0.put(x1,x2),
      _1472: x0 => x0.clear(),
      _1473: x0 => x0.close(),
      _1475: (x0,x1,x2) => x0.open(x1,x2),
      _1476: (x0,x1) => x0.contains(x1),
      _1479: (x0,x1) => x0.createObjectStore(x1),
